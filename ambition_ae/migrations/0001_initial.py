    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sae_reason', models.CharField(choices=[('N/A', 'Not applicable'), ('dead', 'Death'), ('life_threatening', 'Life-threatening'), ('significant_disability', 'Significant disability'), ('in-patient_hospitalization', 'In-patient hospitalization or prolongation (beyond 1 week from study inclusion)'), ('medically_important_event', 'Medically important event (e.g. Severe thrombophlebitis, Bacteraemia, recurrence of symptoms not requiring admission, Hospital acquired pneumonia)')], default='N/A', help_text='If subject deceased, submit a Death Report', max_length=50, verbose_name='If "Yes", reason for SAE:')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ae_received_datetime', models.DateTimeField(blank=True, null=True, validators=[edc_base.model_validators.date.datetime_not_future], verbose_name='Date and time AE form received:')),
                ('clinical_review_datetime', models.DateTimeField(blank=True, null=True, validators=[edc_base.model_validators.date.datetime_not_future], verbose_name='Date and time of clinical review: ')),
                ...
                ('officials_notified', models.DateTimeField(blank=True, null=True, validators=[edc_base.model_validators.date.datetime_not_future], verbose_name='Date and time regulatory authorities notified (SUSARs)')),
                ...
                ('ae_initial', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ambition_ae.AeInitial')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dr_opinion', models.CharField(choices=[('cm_release', 'CM Relapse'), ('cm_iris', 'CM IRIS'), ('OTHER', 'Other')], max_length=10, verbose_name="Study doctor's opinion:")),
                ('dr_opinion_other', models.CharField(blank=True, max_length=50, null=True, verbose_name="If other doctor's opinion, please specify")),
                ('antibiotic_treatment', models.ManyToManyField(to='ambition_ae.AntibioticTreatment', verbose_name='Antibiotics treatment')),
                ('meningitis_symptom', models.ManyToManyField(to='ambition_ae.MeningitisSymptom', verbose_name='What are your current symptoms?')),
                ('neurological', models.ManyToManyField(to='ambition_ae.Neurological', verbose_name='neurologic:')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
            options={
