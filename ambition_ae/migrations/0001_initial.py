# Generated by Django 2.0 on 2017-12-12 01:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tmg_report_datetime', models.DateTimeField(blank=True, help_text='AEs ≥ Grade 4 or SAE must be reported to the Trial Management Group (TMG) within 24 hours (Email to: user@example.com', null=True, verbose_name='Date and time AE reported to TMG')),
            ],
            options={
