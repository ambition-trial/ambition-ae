# Generated by Django 2.0 on 2017-12-03 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_identifier', models.CharField(max_length=25, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_identifier', models.CharField(max_length=25, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, verbose_name='Report Date and Time')),
                ('outcome', models.CharField(choices=[('recovered', 'Recovered/Resolved'), ('recovering', 'Recovering/Resolving at end of study'), ('not_recovered', 'Not Recovered/Resolved at end of study'), ('unknown', 'Unknown/Lost to follow-up'), ('recovered_with_sequelae', 'Recovered with sequelae'), ('Death', 'Death')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ae_grade', models.CharField(choices=[('3', 'Grade 3'), ('4', 'Grade 4 - Life-threatening'), ('5', 'Grade 5 - Death')], max_length=25, verbose_name='Severity of AE')),
                ...
                ('regimen', models.CharField(help_text='Control: (Amphotericin B 1 mg/kg for 7 days with flucytosine 100mg/kg/day for 7 days followed by fluconazole 1200mg/day for 7 days)', max_length=50, verbose_name='Patient’s treatment regimen')),
                ...
                ('tmg_report_datetime', models.DateTimeField(blank=True, help_text='AEs ≥ Grade 4 or SAE must be reported to the Trial Management Group (TMG) within 48hrs (Email to: ambitionreporting@lshtm.ac.uk', null=True, verbose_name='Date and time AE reported to TMG')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_identifier', models.CharField(max_length=50, verbose_name='Subject Identifier')),
                ('tracking_identifier', models.CharField(db_index=True, max_length=25)),
                ('action_identifier', models.CharField(max_length=25, null=True)),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, verbose_name='Report Date and Time')),
                ('relevant_history', models.TextField(help_text='Indicate Adverse Event, Clinical results,medications given, dosage,treatment plan and outcomes.', max_length=1000, verbose_name='Description Summary Of Adverse Event Outcome')),
        ...
        migrations.AddField(
            model_name='aefinal',
            name='ae_initial',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='ambition_ae.AeInitial'),
        ),
    ]
